...
- [ ] Task: Refactor `src/routes/+page.svelte` to support the new layout (sections above the Play area).
- [ ] Task: Verify availability or create UI components for generic scannable cards (e.g., using `shadcn-svelte` Card components).
